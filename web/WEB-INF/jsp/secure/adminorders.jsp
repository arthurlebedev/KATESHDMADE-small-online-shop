...
<head>
    <title>Admin Order List || KATES´S HANDMADE</title>
    <jsp:include page="../commons/head.jsp"/>
    <script type="text/javascript">
        function confirm_delete() {
            return confirm('Do you really sent this item to client?');
        }
    </script>
</head>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Order Administration System</h2>
                ...
                <div class="row">
                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                            ...
                            <div class="htc__shop__cat">
                                ...
                                <ul class="sidebar__list">
                                    ...
                                    <li><a style="color:red" href="adminorders.htm">ORDER LIST<span></span></a></li>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12 smt-30">
                        <c:choose>
                                        ...
                                        <table>
                                            <thead>
                                                <tr style="background-color: lightgray">
                                                    <th class="product-thumbnail">Client ID: <br/>${ord.idcliente}</th>
                                                    <th colspan="2" class="product-thumbnail">Name: <br/>${ord.nombre}</th>
                                                    <th class="product-thumbnail">Phone Number: <br/>${ord.telefono}</th>
                                                    <th colspan="2" class="product-thumbnail">Email: <br/>${ord.correo}</th>
                                                </tr>
                                                <tr style="background-color: lightgray">
                                                    <th colspan="6" class="product-thumbnail">Direccion: ${ord.direccion}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    <tr >
                                                        <td class="product-thumbnail">Order ID: <br/>${ord.idcompra}</td>
                                                        <td class="product-name">Order Date: <br/>${ord.fechacompra}</td>
                                                        <td class="product-name">Shipping Date: <br/>${ord.fechaenvio}</td>
                                                        <td class="product-price">Shipping Status: <br/>${ord.status}</td>
                                                        <td class="product-quantity">Payment Method: <br/>${ord.modopago}</td>
                                                        <td class="product-subtotal">Total Price: <br/>€${ord.preciototal}.00</td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <c:forEach items="${ord.pedlist}" var="ped">       
                                                    ...
                                                    <c:if test="${ord.fechaenvio.equals('NONE')}">
                                                        <tr>
                                                            <td colspan="6" class="product-thumbnail"><a onclick="return confirm_delete()" style="font-weight: bold; font-size: 1.5em" href="adminorders.htm?update=${ord.idcompra}">UPDATE ORDER STATUS AS SENT</a></td>
                                                        </tr>
                                                    </c:if>    
                                            </tbody>
                                        </table>
                            ...
                            <c:otherwise>
                                <h1 align="center" style="color: red; font-weight: bold">There is no any orders in your shop yet</h1>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
